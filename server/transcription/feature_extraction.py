...
class TechniqueFeatureExtractor:
    """Stage 4: Technique Feature Extraction."""
    ...
    def extract_features(self, events: List[Dict[str, Any]], audio_path: str) -> List[Dict[str, Any]]:
        ...
        HARMONIC_INTERVALS = {12, 19, 24, 7, 5}
        ...
        for i, event in enumerate(events):
            ...
            event_copy["technique_features"] = {
                "hnr": hnr, "centroid": centroid, "hpss_ratio": hpss_ratio,
                "zcr": zcr, "flatness": flatness, "onset_strength": onset_strength,
            }
            is_transient = (
